...
public class TextRenderer {
    ...
    public void drawText2D(String text, float x, float y, float fontScale, float r, float g, float b, float a) {
    ...
    public void drawText3D(String text, Vec3 worldPosition, float scale, float r, float g, float b, float a) {
        if (text == null || text.isEmpty()) return;
