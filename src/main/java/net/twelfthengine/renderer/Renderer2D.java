...
public class Renderer2D {
    ...
    public void drawRoundedRect(int x, int y, int w, int h, int radius) {
        ...
        // Corners: triangle fans (angles in standard math: +x right, +y up in trig; screen y increases down)
    ...
    private void cornerFan(float cx, float cy, float r, double startAngle, double endAngle, int segments) {
