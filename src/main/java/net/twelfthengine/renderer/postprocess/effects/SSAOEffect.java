...
public class SSAOEffect extends BasePostProcessEffect {
  ...
  public SSAOEffect() throws Exception {
    shader = new ShaderProgram(
        "/shaders/postprocess/fullscreen.vert", "/shaders/postprocess/ssao.frag");
  ...
  public SSAOEffect radius(float r)     { this.radius     = r; return this; }
  public SSAOEffect intensity(float i)  { this.intensity  = i; return this; }
  public SSAOEffect bias(float b)       { this.bias       = b; return this; }
  public SSAOEffect samples(int s)      { this.samples    = s; return this; }
  public SSAOEffect blurRadius(int r)   { this.blurRadius = r; return this; }
  public SSAOEffect near(float n)       { this.near       = n; return this; }
  public SSAOEffect far(float f)        { this.far        = f; return this; }
