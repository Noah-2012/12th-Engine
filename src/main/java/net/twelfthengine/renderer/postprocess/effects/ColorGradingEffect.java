...
public class ColorGradingEffect extends BasePostProcessEffect {
  ...
  public ColorGradingEffect brightness(float b)               { this.brightness = b; return this; }
  public ColorGradingEffect contrast(float c)                 { this.contrast   = c; return this; }
  public ColorGradingEffect saturation(float s)               { this.saturation = s; return this; }
  public ColorGradingEffect gamma(float g)                    { this.gamma      = g; return this; }
  public ColorGradingEffect shadows(float r, float g, float b)    { shadowR=r; shadowG=g; shadowB=b; return this; }
  public ColorGradingEffect midtones(float r, float g, float b)   { midtoneR=r; midtoneG=g; midtoneB=b; return this; }
  public ColorGradingEffect highlights(float r, float g, float b) { highlightR=r; highlightG=g; highlightB=b; return this; }

  public ColorGradingEffect presetCinematic() {
    return brightness(0.02f).contrast(1.1f).saturation(0.85f).gamma(1.05f)
        .shadows(0.9f, 0.95f, 1.05f).midtones(1.0f, 0.98f, 0.92f).highlights(1.05f, 1.02f, 0.95f);
  }

  public ColorGradingEffect presetHorror() {
    return brightness(-0.05f).contrast(1.2f).saturation(0.6f).gamma(0.9f)
        .shadows(0.8f, 0.9f, 1.1f).midtones(0.9f, 0.95f, 1.0f).highlights(0.95f, 1.0f, 1.05f);
  }
