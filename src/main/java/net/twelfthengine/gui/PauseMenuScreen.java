...
public class PauseMenuScreen {
  ...
  /**
   * GLFW reports cursor position in framebuffer pixels; {@link Renderer2D} uses logical window size
   * for ortho.
   */
  ...
  public void drawButtons(
      Window window, Renderer2D r2d, TextRenderer textRenderer, double cursorX, double cursorY) {
