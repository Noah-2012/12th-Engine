...
public class Window {
    ...
    public void init() {
        ...
        System.out.println("[Window] OpenGL Window created: ID=" + id + " Size=" + width + "x" + height);
    }
    ...
    public boolean shouldClose() { return GLFW.glfwWindowShouldClose(windowHandle); }
    ...
    public void update() { GLFW.glfwSwapBuffers(windowHandle); }
    ...
    public void toggleFullscreen() {
        if (isFullscreen) {
            ...
            GLFW.glfwSetWindowMonitor(windowHandle, 0, windowedX, windowedY, windowedWidth, windowedHeight, GLFW.GLFW_DONT_CARE);
            isFullscreen = false;
            ...
            GLFW.glfwSetWindowMonitor(windowHandle, primaryMonitor, 0, 0, 
